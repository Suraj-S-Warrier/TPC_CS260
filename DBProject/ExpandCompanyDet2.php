...
#stats {    
  ...
  color: white;
    ...
    <?php
        ...
        $sql="select company_name,rollno,recruitment_year,CTC,position from Recruitment_History NATURAL JOIN Common where company_name='$company' and recruitment_year='$rec_year' and spec = '$br' order by CTC;";
